...
pub mod owned {
    ...
    impl ethers::core::abi::AbiDecode for OwnedCalls {
        fn decode(
            ...
            {
                return Ok(OwnedCalls::TransferOwnership(decoded));
            }
    ...
    impl ethers::core::abi::AbiEncode for OwnedCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                OwnedCalls::TransferOwnership(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for OwnedCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                OwnedCalls::TransferOwnership(element) => element.fmt(f),
            }
        }
    }
    ...
    impl ::std::convert::From<TransferOwnershipCall> for OwnedCalls {
        fn from(var: TransferOwnershipCall) -> Self {
            OwnedCalls::TransferOwnership(var)
        }
    }
