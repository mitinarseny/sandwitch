...
pub mod i_pancake_router_02 {
    ...
    #[doc = "IPancakeRouter02 was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    ...
    pub static IPANCAKEROUTER02_ABI: ethers::contract::Lazy<ethers::core::abi::Abi> =
        ethers::contract::Lazy::new(|| {
            ethers::core::utils::__serde_json::from_str(__ABI).expect("invalid abi")
        });
    pub struct IPancakeRouter02<M>(ethers::contract::Contract<M>);
    impl<M> Clone for IPancakeRouter02<M> {
        fn clone(&self) -> Self {
            IPancakeRouter02(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for IPancakeRouter02<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> std::fmt::Debug for IPancakeRouter02<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(IPancakeRouter02))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ethers::providers::Middleware> IPancakeRouter02<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), IPANCAKEROUTER02_ABI.clone(), client)
                .into()
        }
    ...
    impl<M: ethers::providers::Middleware> From<ethers::contract::Contract<M>> for IPancakeRouter02<M> {
    ...
    pub enum IPancakeRouter02Calls {
        Weth(WethCall),
    ...
    impl ethers::core::abi::AbiDecode for IPancakeRouter02Calls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::std::result::Result<Self, ethers::core::abi::AbiError> {
            if let Ok(decoded) = <WethCall as ethers::core::abi::AbiDecode>::decode(data.as_ref()) {
                return Ok(IPancakeRouter02Calls::Weth(decoded));
            }
            if let Ok(decoded) =
                <AddLiquidityCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IPancakeRouter02Calls::AddLiquidity(decoded));
            }
            if let Ok(decoded) =
                <AddLiquidityETHCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IPancakeRouter02Calls::AddLiquidityETH(decoded));
            }
            if let Ok(decoded) =
                <FactoryCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IPancakeRouter02Calls::Factory(decoded));
            }
            if let Ok(decoded) =
                <GetAmountInCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IPancakeRouter02Calls::GetAmountIn(decoded));
            }
            if let Ok(decoded) =
                <GetAmountOutCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IPancakeRouter02Calls::GetAmountOut(decoded));
            }
            if let Ok(decoded) =
                <GetAmountsInCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IPancakeRouter02Calls::GetAmountsIn(decoded));
            }
            if let Ok(decoded) =
                <GetAmountsOutCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IPancakeRouter02Calls::GetAmountsOut(decoded));
            }
            if let Ok(decoded) = <QuoteCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IPancakeRouter02Calls::Quote(decoded));
            }
            if let Ok(decoded) =
                <RemoveLiquidityCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IPancakeRouter02Calls::RemoveLiquidity(decoded));
            }
            if let Ok(decoded) =
                <RemoveLiquidityETHCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IPancakeRouter02Calls::RemoveLiquidityETH(decoded));
            }
            if let Ok (decoded) = < RemoveLiquidityETHSupportingFeeOnTransferTokensCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (IPancakeRouter02Calls :: RemoveLiquidityETHSupportingFeeOnTransferTokens (decoded)) }
            if let Ok(decoded) =
                <RemoveLiquidityETHWithPermitCall as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
                return Ok(IPancakeRouter02Calls::RemoveLiquidityETHWithPermit(decoded));
            }
            if let Ok (decoded) = < RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokensCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (IPancakeRouter02Calls :: RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens (decoded)) }
            if let Ok(decoded) =
                <RemoveLiquidityWithPermitCall as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
                return Ok(IPancakeRouter02Calls::RemoveLiquidityWithPermit(decoded));
            }
            if let Ok(decoded) =
                <SwapETHForExactTokensCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IPancakeRouter02Calls::SwapETHForExactTokens(decoded));
            }
            if let Ok(decoded) =
                <SwapExactETHForTokensCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IPancakeRouter02Calls::SwapExactETHForTokens(decoded));
            }
            if let Ok (decoded) = < SwapExactETHForTokensSupportingFeeOnTransferTokensCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (IPancakeRouter02Calls :: SwapExactETHForTokensSupportingFeeOnTransferTokens (decoded)) }
            if let Ok(decoded) =
                <SwapExactTokensForETHCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IPancakeRouter02Calls::SwapExactTokensForETH(decoded));
            }
            if let Ok (decoded) = < SwapExactTokensForETHSupportingFeeOnTransferTokensCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (IPancakeRouter02Calls :: SwapExactTokensForETHSupportingFeeOnTransferTokens (decoded)) }
            if let Ok(decoded) =
                <SwapExactTokensForTokensCall as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
                return Ok(IPancakeRouter02Calls::SwapExactTokensForTokens(decoded));
            }
            if let Ok (decoded) = < SwapExactTokensForTokensSupportingFeeOnTransferTokensCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (IPancakeRouter02Calls :: SwapExactTokensForTokensSupportingFeeOnTransferTokens (decoded)) }
            if let Ok(decoded) =
                <SwapTokensForExactETHCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IPancakeRouter02Calls::SwapTokensForExactETH(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(IPancakeRouter02Calls::SwapTokensForExactTokens(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ethers::core::abi::AbiEncode for IPancakeRouter02Calls {
        fn encode(self) -> Vec<u8> {
            match self { IPancakeRouter02Calls :: Weth (element) => element . encode () , IPancakeRouter02Calls :: AddLiquidity (element) => element . encode () , IPancakeRouter02Calls :: AddLiquidityETH (element) => element . encode () , IPancakeRouter02Calls :: Factory (element) => element . encode () , IPancakeRouter02Calls :: GetAmountIn (element) => element . encode () , IPancakeRouter02Calls :: GetAmountOut (element) => element . encode () , IPancakeRouter02Calls :: GetAmountsIn (element) => element . encode () , IPancakeRouter02Calls :: GetAmountsOut (element) => element . encode () , IPancakeRouter02Calls :: Quote (element) => element . encode () , IPancakeRouter02Calls :: RemoveLiquidity (element) => element . encode () , IPancakeRouter02Calls :: RemoveLiquidityETH (element) => element . encode () , IPancakeRouter02Calls :: RemoveLiquidityETHSupportingFeeOnTransferTokens (element) => element . encode () , IPancakeRouter02Calls :: RemoveLiquidityETHWithPermit (element) => element . encode () , IPancakeRouter02Calls :: RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens (element) => element . encode () , IPancakeRouter02Calls :: RemoveLiquidityWithPermit (element) => element . encode () , IPancakeRouter02Calls :: SwapETHForExactTokens (element) => element . encode () , IPancakeRouter02Calls :: SwapExactETHForTokens (element) => element . encode () , IPancakeRouter02Calls :: SwapExactETHForTokensSupportingFeeOnTransferTokens (element) => element . encode () , IPancakeRouter02Calls :: SwapExactTokensForETH (element) => element . encode () , IPancakeRouter02Calls :: SwapExactTokensForETHSupportingFeeOnTransferTokens (element) => element . encode () , IPancakeRouter02Calls :: SwapExactTokensForTokens (element) => element . encode () , IPancakeRouter02Calls :: SwapExactTokensForTokensSupportingFeeOnTransferTokens (element) => element . encode () , IPancakeRouter02Calls :: SwapTokensForExactETH (element) => element . encode () , IPancakeRouter02Calls :: SwapTokensForExactTokens (element) => element . encode () }
        }
    }
    impl ::std::fmt::Display for IPancakeRouter02Calls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self { IPancakeRouter02Calls :: Weth (element) => element . fmt (f) , IPancakeRouter02Calls :: AddLiquidity (element) => element . fmt (f) , IPancakeRouter02Calls :: AddLiquidityETH (element) => element . fmt (f) , IPancakeRouter02Calls :: Factory (element) => element . fmt (f) , IPancakeRouter02Calls :: GetAmountIn (element) => element . fmt (f) , IPancakeRouter02Calls :: GetAmountOut (element) => element . fmt (f) , IPancakeRouter02Calls :: GetAmountsIn (element) => element . fmt (f) , IPancakeRouter02Calls :: GetAmountsOut (element) => element . fmt (f) , IPancakeRouter02Calls :: Quote (element) => element . fmt (f) , IPancakeRouter02Calls :: RemoveLiquidity (element) => element . fmt (f) , IPancakeRouter02Calls :: RemoveLiquidityETH (element) => element . fmt (f) , IPancakeRouter02Calls :: RemoveLiquidityETHSupportingFeeOnTransferTokens (element) => element . fmt (f) , IPancakeRouter02Calls :: RemoveLiquidityETHWithPermit (element) => element . fmt (f) , IPancakeRouter02Calls :: RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens (element) => element . fmt (f) , IPancakeRouter02Calls :: RemoveLiquidityWithPermit (element) => element . fmt (f) , IPancakeRouter02Calls :: SwapETHForExactTokens (element) => element . fmt (f) , IPancakeRouter02Calls :: SwapExactETHForTokens (element) => element . fmt (f) , IPancakeRouter02Calls :: SwapExactETHForTokensSupportingFeeOnTransferTokens (element) => element . fmt (f) , IPancakeRouter02Calls :: SwapExactTokensForETH (element) => element . fmt (f) , IPancakeRouter02Calls :: SwapExactTokensForETHSupportingFeeOnTransferTokens (element) => element . fmt (f) , IPancakeRouter02Calls :: SwapExactTokensForTokens (element) => element . fmt (f) , IPancakeRouter02Calls :: SwapExactTokensForTokensSupportingFeeOnTransferTokens (element) => element . fmt (f) , IPancakeRouter02Calls :: SwapTokensForExactETH (element) => element . fmt (f) , IPancakeRouter02Calls :: SwapTokensForExactTokens (element) => element . fmt (f) }
        }
    }
    impl ::std::convert::From<WethCall> for IPancakeRouter02Calls {
        fn from(var: WethCall) -> Self {
            IPancakeRouter02Calls::Weth(var)
        }
    }
    impl ::std::convert::From<AddLiquidityCall> for IPancakeRouter02Calls {
        fn from(var: AddLiquidityCall) -> Self {
            IPancakeRouter02Calls::AddLiquidity(var)
        }
    }
    impl ::std::convert::From<AddLiquidityETHCall> for IPancakeRouter02Calls {
        fn from(var: AddLiquidityETHCall) -> Self {
            IPancakeRouter02Calls::AddLiquidityETH(var)
        }
    }
    impl ::std::convert::From<FactoryCall> for IPancakeRouter02Calls {
        fn from(var: FactoryCall) -> Self {
            IPancakeRouter02Calls::Factory(var)
        }
    }
    impl ::std::convert::From<GetAmountInCall> for IPancakeRouter02Calls {
        fn from(var: GetAmountInCall) -> Self {
            IPancakeRouter02Calls::GetAmountIn(var)
        }
    }
    impl ::std::convert::From<GetAmountOutCall> for IPancakeRouter02Calls {
        fn from(var: GetAmountOutCall) -> Self {
            IPancakeRouter02Calls::GetAmountOut(var)
        }
    }
    impl ::std::convert::From<GetAmountsInCall> for IPancakeRouter02Calls {
        fn from(var: GetAmountsInCall) -> Self {
            IPancakeRouter02Calls::GetAmountsIn(var)
        }
    }
    impl ::std::convert::From<GetAmountsOutCall> for IPancakeRouter02Calls {
        fn from(var: GetAmountsOutCall) -> Self {
            IPancakeRouter02Calls::GetAmountsOut(var)
        }
    }
    impl ::std::convert::From<QuoteCall> for IPancakeRouter02Calls {
        fn from(var: QuoteCall) -> Self {
            IPancakeRouter02Calls::Quote(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityCall> for IPancakeRouter02Calls {
        fn from(var: RemoveLiquidityCall) -> Self {
            IPancakeRouter02Calls::RemoveLiquidity(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityETHCall> for IPancakeRouter02Calls {
        fn from(var: RemoveLiquidityETHCall) -> Self {
            IPancakeRouter02Calls::RemoveLiquidityETH(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityETHSupportingFeeOnTransferTokensCall>
        for IPancakeRouter02Calls
    {
        fn from(var: RemoveLiquidityETHSupportingFeeOnTransferTokensCall) -> Self {
            IPancakeRouter02Calls::RemoveLiquidityETHSupportingFeeOnTransferTokens(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityETHWithPermitCall> for IPancakeRouter02Calls {
        fn from(var: RemoveLiquidityETHWithPermitCall) -> Self {
            IPancakeRouter02Calls::RemoveLiquidityETHWithPermit(var)
        }
    }
        ...
        for IPancakeRouter02Calls
    {
        fn from(var: RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokensCall) -> Self {
            IPancakeRouter02Calls::RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityWithPermitCall> for IPancakeRouter02Calls {
        fn from(var: RemoveLiquidityWithPermitCall) -> Self {
            IPancakeRouter02Calls::RemoveLiquidityWithPermit(var)
        }
    }
    impl ::std::convert::From<SwapETHForExactTokensCall> for IPancakeRouter02Calls {
        fn from(var: SwapETHForExactTokensCall) -> Self {
            IPancakeRouter02Calls::SwapETHForExactTokens(var)
        }
    }
    impl ::std::convert::From<SwapExactETHForTokensCall> for IPancakeRouter02Calls {
        fn from(var: SwapExactETHForTokensCall) -> Self {
            IPancakeRouter02Calls::SwapExactETHForTokens(var)
        }
    }
        ...
        for IPancakeRouter02Calls
    {
        fn from(var: SwapExactETHForTokensSupportingFeeOnTransferTokensCall) -> Self {
            IPancakeRouter02Calls::SwapExactETHForTokensSupportingFeeOnTransferTokens(var)
        }
    }
    impl ::std::convert::From<SwapExactTokensForETHCall> for IPancakeRouter02Calls {
        fn from(var: SwapExactTokensForETHCall) -> Self {
            IPancakeRouter02Calls::SwapExactTokensForETH(var)
        }
    }
        ...
        for IPancakeRouter02Calls
    {
        fn from(var: SwapExactTokensForETHSupportingFeeOnTransferTokensCall) -> Self {
            IPancakeRouter02Calls::SwapExactTokensForETHSupportingFeeOnTransferTokens(var)
        }
    }
    impl ::std::convert::From<SwapExactTokensForTokensCall> for IPancakeRouter02Calls {
        fn from(var: SwapExactTokensForTokensCall) -> Self {
            IPancakeRouter02Calls::SwapExactTokensForTokens(var)
        }
    }
        ...
        for IPancakeRouter02Calls
    {
        fn from(var: SwapExactTokensForTokensSupportingFeeOnTransferTokensCall) -> Self {
            IPancakeRouter02Calls::SwapExactTokensForTokensSupportingFeeOnTransferTokens(var)
        }
    }
    impl ::std::convert::From<SwapTokensForExactETHCall> for IPancakeRouter02Calls {
        fn from(var: SwapTokensForExactETHCall) -> Self {
            IPancakeRouter02Calls::SwapTokensForExactETH(var)
        }
    }
    impl ::std::convert::From<SwapTokensForExactTokensCall> for IPancakeRouter02Calls {
        fn from(var: SwapTokensForExactTokensCall) -> Self {
            IPancakeRouter02Calls::SwapTokensForExactTokens(var)
        }
    }
